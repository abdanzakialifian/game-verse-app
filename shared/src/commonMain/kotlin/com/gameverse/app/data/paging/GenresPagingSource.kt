...
class GenresPagingSource(
...
) : PagingSource<Int, GenresResponse.ResultsItem>() {
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, GenresResponse.ResultsItem> =
        try {
    ...
    override fun getRefreshKey(state: PagingState<Int, GenresResponse.ResultsItem>): Int? =
